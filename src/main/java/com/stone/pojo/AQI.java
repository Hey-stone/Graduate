...
public class AQI implements Serializable{
	 ...
	 * @param time_point
	 */
	public AQI(Integer id, Integer aqi, String area, Double co, Double co_24h,
			Double no2, Double no2_24h, Double o3, Double o3_24h, Double o3_8h,
			Double o3_8h_24h, Double pm10, Double pm10_24h, Double pm2_5,
			Double pm2_5_24h, String level, String primary_pollutant,
			String quality, Double so2, Double so2_24h, Timestamp time_point) {
		super();
		this.id = id;
		this.aqi = aqi;
		this.area = area;
	...
	public String toString() {
		return "AQI [id=" + id + ", aqi=" + aqi + ", area=" + area + ", co="
				+ co + ", co_24h=" + co_24h + ", no2=" + no2 + ", no2_24h="
				+ no2_24h + ", o3=" + o3 + ", o3_24h=" + o3_24h + ", o3_8h="
				+ o3_8h + ", o3_8h_24h=" + o3_8h_24h + ", pm10=" + pm10
				+ ", pm10_24h=" + pm10_24h + ", pm2_5=" + pm2_5
